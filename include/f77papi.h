...
!
      ...
      PARAMETER (PAPI_VER_CURRENT=67174400)
      INTEGER PAPI_VERSION      
      PARAMETER (PAPI_VERSION=67175168)
      ...
      INTEGER PAPI_EDGE_DETECT  
      PARAMETER (PAPI_EDGE_DETECT=9)
      INTEGER PAPI_INVERT       
      PARAMETER (PAPI_INVERT=10)
