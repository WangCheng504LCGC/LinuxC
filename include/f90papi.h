...
!
      ...
      INTEGER, PARAMETER :: PAPI_VER_CURRENT   = 67174400
      INTEGER, PARAMETER :: PAPI_VERSION       = 67175168
      ...
      INTEGER, PARAMETER :: PAPI_EDGE_DETECT   = 9
      INTEGER, PARAMETER :: PAPI_INVERT        = 10
